...
return [
    ...
    */
    'drivers' => [
        'chromium' => [
            'binary' => env('PDF_STUDIO_CHROMIUM_BINARY') ?: env('BROWSERSHOT_CHROME_PATH') ?: null,
            'node_binary' => env('PDF_STUDIO_NODE_BINARY') ?: null,
            'npm_binary' => env('PDF_STUDIO_NPM_BINARY') ?: null,
            'timeout' => (int) env('PDF_STUDIO_CHROMIUM_TIMEOUT', 60),
            'no_sandbox' => filter_var(env('PDF_STUDIO_CHROMIUM_NO_SANDBOX', true), FILTER_VALIDATE_BOOL),
            'options' => [],
        ],
        'cloudflare' => [
