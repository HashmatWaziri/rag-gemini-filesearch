...
We take the security of **GLC AI Platform** and the privacy of our users' health data seriously. We appreciate the community's help in disclosing vulnerabilities responsibly.
...
If you have discovered a security vulnerability in GLC AI Platform (e.g., XSS, SQL Injection, Authorization Bypass, or Data Leakage), please report it privately.
...
GLC AI Platform stores sensitive data (Blood Glucose Readings, Biometrics). While this is an open-source project often run locally, we treat the code architecture with high security standards to protect this data. We welcome audits specifically targeting the `GlucoseReading` and `User` models to ensure tenant isolation is strictly enforced.

---

*Thank you for helping keep the GLC AI Platform community safe.*