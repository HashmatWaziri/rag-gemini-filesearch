@section('title', ($mealPlan->name ?? 'Meal Plan') . ' - Printable Version | GLC AI Platform')
...
<x-default-layout>
    ...
    >
        ...
        <footer class="mt-8 border-t border-slate-200 pt-4 text-center text-xs text-slate-500 print:border-slate-300 print:text-slate-500 print:dark:border-slate-300 print:dark:text-slate-500">
            <p>Generated by <strong>GLC AI Platform</strong> • {{ now()->format('F j, Y') }}</p>
            <p class="mt-1">Generated by GLC AI Platform</p>
        </footer>
    </article>
</x-default-layout>
