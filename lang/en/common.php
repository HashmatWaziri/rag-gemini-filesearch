...
return [
    ...
    'checkout_subscription' => [
        ...
        'trial_info_description' => 'GLC AI Platform is 100% open source, but generating personalized AI meal plans costs us real money in API tokens. Your subscription ensures the project stays sustainable and independent.',
    ...
    'grocery_list_print' => [
        ...
        'generated_by' => 'Generated by GLC AI Platform • :date',
    ...
    'mobile_sync' => [
        'title' => 'Mobile Sync',
        'description' => 'Connect your GLC Health Sync iOS app to sync Apple Health data.',
        'no_devices' => 'No devices connected yet.',
        'no_devices_description' => 'Generate a pairing code to connect your GLC Health Sync iOS app. Your health data will be synced securely from your device.',
        'generate_token' => 'Generate Pairing Code',
        'regenerate_token' => 'Regenerate Code',
        'pairing_code' => 'Pairing Code',
        'scan_qr' => 'Scan this QR code with the GLC Health Sync app',
        'or_enter_token' => 'Or enter this code manually',
        'expires_at' => 'Expires',
        'steps_title' => 'How to pair',
        'step_1' => 'Open the GLC Health Sync app on your iPhone',
