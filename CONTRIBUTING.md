...
-   **PHP**: We follow [PSR-12](https://www.php-fig.org/psr/psr-12/) coding standards. We use [Laravel Pint](https://laravel.com/docs/pint) to fix code style issues. Run `composer lint` before committing.
-   **JavaScript/TypeScript**: We use ESLint and Prettier. Run `npm run lint` to check for issues.
-   **Tests**: Please ensure all tests pass. We use [Pest](https://pestphp.com/) for testing.
