...
use App\Http\Controllers\Glc\Tutor\TutorSetupController;
...
Route::prefix('staff')->name('staff.')->middleware(['auth', 'glc.role:teacher,academic_supervisor,admin'])->group(function (): void {
    Route::get('/tutor-setup', [TutorSetupController::class, 'index'])->name('tutor-setup.index');
    ...
    Route::put('/students/assignments', [StudentAssignmentController::class, 'bulkUpdate'])->name('students.assignment.bulk');
    ...
    Route::post('/tutor/students/{student}/progress-report', [StaffTutorController::class, 'storeProgressReport'])
        ->name('tutor.students.progress-report.store');
